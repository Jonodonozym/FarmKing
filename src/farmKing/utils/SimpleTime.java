...
public class SimpleTime{
	...
	public static void main(String[] args){
		SimpleTime t = new SimpleTime(2000,0,0,0,0);
		System.out.println(new SimpleTime(2001,0,0,0,0).timeAfter(t));
		System.out.println(new SimpleTime(2000,1,0,0,0).timeAfter(t));
		System.out.println(new SimpleTime(2000,0,1,0,0).timeAfter(t));
		System.out.println(new SimpleTime(2000,0,0,1,0).timeAfter(t));
		System.out.println(new SimpleTime(2000,0,0,0,1).timeAfter(t));
	}
}